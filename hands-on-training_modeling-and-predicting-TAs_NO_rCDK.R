...
# saveRDS(fp_df, "pre_generated/fp_df.RDS")

fp_df <- readRDS("pre_generated/fp_df.RDS")
...
# saveRDS(fp_df_new, "pre_generated/fp_df_new.RDS")
fp_df_new <- readRDS("pre_generated/fp_df_new.RDS")
